...
const char vertGouraud[] = STRINGIFY(
...
const char fragGouraud[] = STRINGIFY(
...
class GouraudShader : public ANAS::ShaderBase
{

public:
	GouraudShader() : ANAS::ShaderBase(vertGouraud, fragGouraud)
	{
