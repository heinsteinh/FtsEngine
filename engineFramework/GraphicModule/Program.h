...
namespace zephyr {
	namespace gfx {
		...
		namespace detail {
			...
			inline const std::unordered_map<std::string, GLuint> getUniforms(GLuint program)
			{
			...
			inline std::unordered_map<std::string, GLuint> getAttributes(GLuint program)
			{
		...
		public:
			...
			typedef std::unordered_map<std::string, GLuint> AttributeMap;
