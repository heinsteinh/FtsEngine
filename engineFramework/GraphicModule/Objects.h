...
namespace zephyr {
	namespace gfx {
		...
		struct Material : public std::enable_shared_from_this<Material> 
		{
			...
			explicit Material(ProgramPtr program, UniformMap uniforms = UniformMap{}, TextureMap textures = TextureMap{}) 
		...
		struct Object : public std::enable_shared_from_this<Object> 
		{
			...
			explicit Object(EntityPtr entity, WeakObjectPtr parent = WeakObjectPtr{}) : entity{ std::move(entity) }, parent{ std::move(parent) }
			{ }
