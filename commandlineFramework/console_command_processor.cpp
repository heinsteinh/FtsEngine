...
namespace wmdf
{
	ConsoleCommandProcessor::ConsoleCommandProcessor(void)
	{
		...
		console_command_manager_ = &ConsoleCommandManager::GetInstance();
	...
	void ConsoleCommandProcessor::ProcessConsoleCommand(const std::string& command_line)
	{
		...
		std::string command_tag = ConsoleCommandParser::ParseCommandName(command_string);
