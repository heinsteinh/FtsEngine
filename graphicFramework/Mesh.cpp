...
//https://github.com/marcinlos/zephyr/blob/4afba790ae3b4d3bb6513c2c0d550b5df40f204a/Zephyr/src/zephyr/gfx/Mesh.cpp
...
namespace zephyr {
	namespace gfx {
		...
		std::vector<glm::vec4> randomColors(std::size_t count) {
			std::default_random_engine generator((unsigned int)std::time(nullptr));
